...
func (m *PageOfNSXTIPAddressPool) validateElements(formats strfmt.Registry) error {
...
func (m *PageOfNSXTIPAddressPool) validatePageMetadata(formats strfmt.Registry) error {
...
func (m *PageOfNSXTIPAddressPool) contextValidateElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfNSXTIPAddressPool) contextValidatePageMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfNSXTIPAddressPool) UnmarshalBinary(b []byte) error {
	var res PageOfNSXTIPAddressPool
