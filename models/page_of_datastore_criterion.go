...
func (m *PageOfDatastoreCriterion) validateElements(formats strfmt.Registry) error {
...
func (m *PageOfDatastoreCriterion) validatePageMetadata(formats strfmt.Registry) error {
...
func (m *PageOfDatastoreCriterion) contextValidateElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfDatastoreCriterion) contextValidatePageMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfDatastoreCriterion) UnmarshalBinary(b []byte) error {
	var res PageOfDatastoreCriterion
