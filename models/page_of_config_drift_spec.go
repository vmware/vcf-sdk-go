...
// Validate validates this page of config drift spec
func (m *PageOfConfigDriftSpec) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PageOfConfigDriftSpec) validateElements(formats strfmt.Registry) error {
...
func (m *PageOfConfigDriftSpec) validatePageMetadata(formats strfmt.Registry) error {
...
func (m *PageOfConfigDriftSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *PageOfConfigDriftSpec) contextValidateElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfConfigDriftSpec) contextValidatePageMetadata(ctx context.Context, formats strfmt.Registry) error {
