...
func (m *PageOfIdentityProvider) validateElements(formats strfmt.Registry) error {
...
func (m *PageOfIdentityProvider) validatePageMetadata(formats strfmt.Registry) error {
...
func (m *PageOfIdentityProvider) contextValidateElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfIdentityProvider) contextValidatePageMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfIdentityProvider) UnmarshalBinary(b []byte) error {
	var res PageOfIdentityProvider
