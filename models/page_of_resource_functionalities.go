...
func (m *PageOfResourceFunctionalities) validateElements(formats strfmt.Registry) error {
...
func (m *PageOfResourceFunctionalities) validatePageMetadata(formats strfmt.Registry) error {
...
func (m *PageOfResourceFunctionalities) contextValidateElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfResourceFunctionalities) contextValidatePageMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfResourceFunctionalities) UnmarshalBinary(b []byte) error {
	var res PageOfResourceFunctionalities
