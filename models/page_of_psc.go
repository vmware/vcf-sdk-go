...
func (m *PageOfPsc) validateElements(formats strfmt.Registry) error {
...
func (m *PageOfPsc) validatePageMetadata(formats strfmt.Registry) error {
...
func (m *PageOfPsc) contextValidateElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfPsc) contextValidatePageMetadata(ctx context.Context, formats strfmt.Registry) error {
