...
func (m *PageOfDomainFutureRelease) validateElements(formats strfmt.Registry) error {
...
func (m *PageOfDomainFutureRelease) validatePageMetadata(formats strfmt.Registry) error {
...
func (m *PageOfDomainFutureRelease) contextValidateElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfDomainFutureRelease) contextValidatePageMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfDomainFutureRelease) UnmarshalBinary(b []byte) error {
	var res PageOfDomainFutureRelease
