...
func (m *PageOfEdgeClusterNSXTEntityCriterion) validateElements(formats strfmt.Registry) error {
...
func (m *PageOfEdgeClusterNSXTEntityCriterion) validatePageMetadata(formats strfmt.Registry) error {
...
func (m *PageOfEdgeClusterNSXTEntityCriterion) contextValidateElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfEdgeClusterNSXTEntityCriterion) contextValidatePageMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfEdgeClusterNSXTEntityCriterion) UnmarshalBinary(b []byte) error {
	var res PageOfEdgeClusterNSXTEntityCriterion
