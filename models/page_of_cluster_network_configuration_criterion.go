...
type PageOfClusterNetworkConfigurationCriterion struct {
	...
	Elements []*ClusterNetworkConfigurationCriterion `json:"elements"`

	// Pageable elements pagination metadata information
	PageMetadata *PageMetadata `json:"pageMetadata,omitempty"`
}

// Validate validates this page of cluster network configuration criterion
...
func (m *PageOfClusterNetworkConfigurationCriterion) validateElements(formats strfmt.Registry) error {
...
func (m *PageOfClusterNetworkConfigurationCriterion) validatePageMetadata(formats strfmt.Registry) error {
...
func (m *PageOfClusterNetworkConfigurationCriterion) contextValidateElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfClusterNetworkConfigurationCriterion) contextValidatePageMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfClusterNetworkConfigurationCriterion) UnmarshalBinary(b []byte) error {
	var res PageOfClusterNetworkConfigurationCriterion
