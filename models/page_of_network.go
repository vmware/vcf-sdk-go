...
func (m *PageOfNetwork) validateElements(formats strfmt.Registry) error {
...
func (m *PageOfNetwork) validatePageMetadata(formats strfmt.Registry) error {
...
func (m *PageOfNetwork) contextValidateElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfNetwork) contextValidatePageMetadata(ctx context.Context, formats strfmt.Registry) error {
