...
func (m *PageOfVcfService) validateElements(formats strfmt.Registry) error {
...
func (m *PageOfVcfService) validatePageMetadata(formats strfmt.Registry) error {
...
func (m *PageOfVcfService) contextValidateElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfVcfService) contextValidatePageMetadata(ctx context.Context, formats strfmt.Registry) error {
