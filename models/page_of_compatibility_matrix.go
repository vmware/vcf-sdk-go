...
// Validate validates this page of compatibility matrix
...
func (m *PageOfCompatibilityMatrix) validateElements(formats strfmt.Registry) error {
...
func (m *PageOfCompatibilityMatrix) validatePageMetadata(formats strfmt.Registry) error {
...
func (m *PageOfCompatibilityMatrix) contextValidateElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfCompatibilityMatrix) contextValidatePageMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfCompatibilityMatrix) UnmarshalBinary(b []byte) error {
	var res PageOfCompatibilityMatrix
