...
func (m *HealthCheckTask) validateID(formats strfmt.Registry) error {
...
func (m *HealthCheckTask) validateResourceStatus(formats strfmt.Registry) error {
...
func (m *HealthCheckTask) validateStatus(formats strfmt.Registry) error {
