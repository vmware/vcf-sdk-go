...
func (m *PageOfDomainIntegration) validateElements(formats strfmt.Registry) error {
...
func (m *PageOfDomainIntegration) validatePageMetadata(formats strfmt.Registry) error {
...
func (m *PageOfDomainIntegration) contextValidateElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfDomainIntegration) contextValidatePageMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfDomainIntegration) UnmarshalBinary(b []byte) error {
	var res PageOfDomainIntegration
