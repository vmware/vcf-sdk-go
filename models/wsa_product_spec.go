...
func (m *WSAProductSpec) Validate(formats strfmt.Registry) error {
	...
	if err := m.validateDefaultAdminCredentials(formats); err != nil {
		res = append(res, err)
	}
...
func (m *WSAProductSpec) validateAdminCredentials(formats strfmt.Registry) error {
...
func (m *WSAProductSpec) validateDefaultAdminCredentials(formats strfmt.Registry) error {

	if err := validate.Required("defaultAdminCredentials", "body", m.DefaultAdminCredentials); err != nil {
		return err
	}

	if m.DefaultAdminCredentials != nil {
		if err := m.DefaultAdminCredentials.Validate(formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("defaultAdminCredentials")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("defaultAdminCredentials")
			}
			return err
		}
	}
...
func (m *WSAProductSpec) validateLoadBalancerFqdn(formats strfmt.Registry) error {
...
func (m *WSAProductSpec) validateNodes(formats strfmt.Registry) error {
...
func (m *WSAProductSpec) validateType(formats strfmt.Registry) error {
...
func (m *WSAProductSpec) validateVersion(formats strfmt.Registry) error {
...
func (m *WSAProductSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	...
	if err := m.contextValidateDefaultAdminCredentials(ctx, formats); err != nil {
		res = append(res, err)
	}
...
func (m *WSAProductSpec) contextValidateAdminCredentials(ctx context.Context, formats strfmt.Registry) error {
...
func (m *WSAProductSpec) contextValidateDefaultAdminCredentials(ctx context.Context, formats strfmt.Registry) error {

	if m.DefaultAdminCredentials != nil {

		if err := m.DefaultAdminCredentials.ContextValidate(ctx, formats); err != nil {
			if ve, ok := err.(*errors.Validation); ok {
				return ve.ValidateName("defaultAdminCredentials")
			} else if ce, ok := err.(*errors.CompositeError); ok {
				return ce.ValidateName("defaultAdminCredentials")
...
func (m *WSAProductSpec) contextValidateNodes(ctx context.Context, formats strfmt.Registry) error {
