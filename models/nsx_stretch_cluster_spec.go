...
// Validate validates this nsx stretch cluster spec
func (m *NsxStretchClusterSpec) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *NsxStretchClusterSpec) validateIPAddressPoolsSpec(formats strfmt.Registry) error {
...
func (m *NsxStretchClusterSpec) validateUplinkProfiles(formats strfmt.Registry) error {

	if err := validate.Required("uplinkProfiles", "body", m.UplinkProfiles); err != nil {
		return err
	}
...
func (m *NsxStretchClusterSpec) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	var res []error
...
func (m *NsxStretchClusterSpec) contextValidateIPAddressPoolsSpec(ctx context.Context, formats strfmt.Registry) error {
...
func (m *NsxStretchClusterSpec) contextValidateUplinkProfiles(ctx context.Context, formats strfmt.Registry) error {
