...
type PageOfNetworkConfigProfile struct {

	// The list of elements included in this page
	Elements []NetworkConfigProfile `json:"elements"`

	// Pageable elements pagination metadata information
	PageMetadata *PageMetadata `json:"pageMetadata,omitempty"`
}

// Validate validates this page of network config profile
...
func (m *PageOfNetworkConfigProfile) validatePageMetadata(formats strfmt.Registry) error {
...
func (m *PageOfNetworkConfigProfile) contextValidatePageMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfNetworkConfigProfile) UnmarshalBinary(b []byte) error {
	var res PageOfNetworkConfigProfile
