...
func (m *LocalUser) validateName(formats strfmt.Registry) error {
...
func (m *LocalUser) validateRole(formats strfmt.Registry) error {
...
func (m *LocalUser) validateType(formats strfmt.Registry) error {
...
func (m *LocalUser) contextValidateRole(ctx context.Context, formats strfmt.Registry) error {
