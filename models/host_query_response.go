...
func (m *HostQueryResponse) validateQueryInfo(formats strfmt.Registry) error {
...
func (m *HostQueryResponse) validateResult(formats strfmt.Registry) error {
