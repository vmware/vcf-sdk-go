...
func (m *DatastoreQueryResponse) validateQueryInfo(formats strfmt.Registry) error {
...
func (m *DatastoreQueryResponse) validateResult(formats strfmt.Registry) error {
...
func (m *DatastoreQueryResponse) UnmarshalBinary(b []byte) error {
	var res DatastoreQueryResponse
