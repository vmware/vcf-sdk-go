...
func (m *PageOfSDDCTask) validateElements(formats strfmt.Registry) error {
...
func (m *PageOfSDDCTask) validatePageMetadata(formats strfmt.Registry) error {
...
func (m *PageOfSDDCTask) contextValidateElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfSDDCTask) contextValidatePageMetadata(ctx context.Context, formats strfmt.Registry) error {
