...
func (m *PageOfRelease) validateElements(formats strfmt.Registry) error {
...
func (m *PageOfRelease) validatePageMetadata(formats strfmt.Registry) error {
...
func (m *PageOfRelease) contextValidateElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfRelease) contextValidatePageMetadata(ctx context.Context, formats strfmt.Registry) error {
