...
// Validate validates this page of Nsxt transport zone info
...
func (m *PageOfNSXTTransportZoneInfo) validateElements(formats strfmt.Registry) error {
...
func (m *PageOfNSXTTransportZoneInfo) validatePageMetadata(formats strfmt.Registry) error {
...
func (m *PageOfNSXTTransportZoneInfo) contextValidateElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfNSXTTransportZoneInfo) contextValidatePageMetadata(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfNSXTTransportZoneInfo) UnmarshalBinary(b []byte) error {
	var res PageOfNSXTTransportZoneInfo
