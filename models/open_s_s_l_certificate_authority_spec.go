...
// Validate validates this open s s l certificate authority spec
...
// ContextValidate validates this open s s l certificate authority spec based on context it is used
