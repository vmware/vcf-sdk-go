...
func (m *PageOfValidation) validateElements(formats strfmt.Registry) error {
...
func (m *PageOfValidation) validatePageMetadata(formats strfmt.Registry) error {
...
func (m *PageOfValidation) contextValidateElements(ctx context.Context, formats strfmt.Registry) error {
...
func (m *PageOfValidation) contextValidatePageMetadata(ctx context.Context, formats strfmt.Registry) error {
