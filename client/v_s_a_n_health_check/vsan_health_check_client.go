...
// New creates a new v s a n health check API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

/*
Client for v s a n health check API
*/
type Client struct {
...
/*
GetHealthCheckQuery gets v s a n health check status
...
func (a *Client) GetHealthCheckQuery(params *GetHealthCheckQueryParams, opts ...ClientOption) (*GetHealthCheckQueryOK, *GetHealthCheckQueryAccepted, error) {
	...
	msg := fmt.Sprintf("unexpected success response for v_s_a_n_health_check: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}

/*
GetHealthCheckStatus gets v s a n health check status by query Id
...
/*
GetHealthCheckStatusTask gets v s a n health check update task status
...
/*
SetHealthCheckStatus updates v s a n health check status
