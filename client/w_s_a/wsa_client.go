...
// New creates a new w s a API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

/*
Client for w s a API
*/
type Client struct {
...
func (a *Client) GetWsas(params *GetWsasParams, opts ...ClientOption) (*GetWsasOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for getWsas: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
