...
func (o *GetProxyConfigurationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/system/proxy-configuration] getProxyConfiguration", response, response.Code())
	}
}
...
// Code gets the status code for the get proxy configuration o k response
func (o *GetProxyConfigurationOK) Code() int {
	return 200
}
...
// Code gets the status code for the get proxy configuration bad request response
func (o *GetProxyConfigurationBadRequest) Code() int {
	return 400
}
...
// Code gets the status code for the get proxy configuration internal server error response
func (o *GetProxyConfigurationInternalServerError) Code() int {
	return 500
}
