...
// IsSuccess returns true when this download c s r o k response has a 2xx status code
func (o *DownloadCSROK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this download c s r o k response has a 3xx status code
func (o *DownloadCSROK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this download c s r o k response has a 4xx status code
func (o *DownloadCSROK) IsClientError() bool {
	return false
}

// IsServerError returns true when this download c s r o k response has a 5xx status code
func (o *DownloadCSROK) IsServerError() bool {
	return false
}

// IsCode returns true when this download c s r o k response a status code equal to that given
...
// IsSuccess returns true when this download c s r not found response has a 2xx status code
func (o *DownloadCSRNotFound) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this download c s r not found response has a 3xx status code
func (o *DownloadCSRNotFound) IsRedirect() bool {
	return false
}

// IsClientError returns true when this download c s r not found response has a 4xx status code
func (o *DownloadCSRNotFound) IsClientError() bool {
	return true
}

// IsServerError returns true when this download c s r not found response has a 5xx status code
func (o *DownloadCSRNotFound) IsServerError() bool {
	return false
}

// IsCode returns true when this download c s r not found response a status code equal to that given
...
// IsSuccess returns true when this download c s r internal server error response has a 2xx status code
func (o *DownloadCSRInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this download c s r internal server error response has a 3xx status code
func (o *DownloadCSRInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this download c s r internal server error response has a 4xx status code
func (o *DownloadCSRInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this download c s r internal server error response has a 5xx status code
func (o *DownloadCSRInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this download c s r internal server error response a status code equal to that given
