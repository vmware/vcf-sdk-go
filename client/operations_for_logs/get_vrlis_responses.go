...
func (o *GetVrlisReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/vrlis] getVrlis", response, response.Code())
	}
}
...
// Code gets the status code for the get vrlis o k response
func (o *GetVrlisOK) Code() int {
	return 200
}
