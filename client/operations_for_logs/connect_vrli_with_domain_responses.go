...
func (o *ConnectVrliWithDomainReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 202:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[PUT /v1/vrli/domains] connectVrliWithDomain", response, response.Code())
	}
}
...
// Code gets the status code for the connect vrli with domain o k response
func (o *ConnectVrliWithDomainOK) Code() int {
	return 200
}
...
// Code gets the status code for the connect vrli with domain accepted response
func (o *ConnectVrliWithDomainAccepted) Code() int {
	return 202
}
