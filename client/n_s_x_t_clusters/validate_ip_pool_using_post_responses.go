...
// IsSuccess returns true when this validate Ip pool using Post o k response has a 2xx status code
func (o *ValidateIPPoolUsingPOSTOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this validate Ip pool using Post o k response has a 3xx status code
func (o *ValidateIPPoolUsingPOSTOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this validate Ip pool using Post o k response has a 4xx status code
func (o *ValidateIPPoolUsingPOSTOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this validate Ip pool using Post o k response has a 5xx status code
func (o *ValidateIPPoolUsingPOSTOK) IsServerError() bool {
	return false
}

// IsCode returns true when this validate Ip pool using Post o k response a status code equal to that given
