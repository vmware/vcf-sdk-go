...
func (o *GetVrasReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/vras] getVras", response, response.Code())
	}
}
...
// Code gets the status code for the get vras o k response
func (o *GetVrasOK) Code() int {
	return 200
}
