...
/*
GetVras retrieves a list of v mware aria automation instances
*/
func (a *Client) GetVras(params *GetVrasParams, opts ...ClientOption) (*GetVrasOK, error) {
	...
	msg := fmt.Sprintf("unexpected success response for getVras: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
