...
func (o *GetDomainLicensingInfoReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		result := NewGetDomainLicensingInfoOK()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return result, nil
	case 500:
		result := NewGetDomainLicensingInfoInternalServerError()
		if err := result.readResponse(response, consumer, o.formats); err != nil {
			return nil, err
		}
		return nil, result
...
func NewGetDomainLicensingInfoOK() *GetDomainLicensingInfoOK {
	return &GetDomainLicensingInfoOK{}
}
...
func (o *GetDomainLicensingInfoOK) Error() string {
	return fmt.Sprintf("[GET /v1/licensing-info/domains/{id}][%d] getDomainLicensingInfoOK  %+v", 200, o.Payload)
}
...
func (o *GetDomainLicensingInfoOK) GetPayload() *models.LicensingInfo {
	return o.Payload
}

func (o *GetDomainLicensingInfoOK) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
...
func NewGetDomainLicensingInfoInternalServerError() *GetDomainLicensingInfoInternalServerError {
	return &GetDomainLicensingInfoInternalServerError{}
}
...
func (o *GetDomainLicensingInfoInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this get domain licensing info internal server error response has a 3xx status code
func (o *GetDomainLicensingInfoInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this get domain licensing info internal server error response has a 4xx status code
func (o *GetDomainLicensingInfoInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this get domain licensing info internal server error response has a 5xx status code
func (o *GetDomainLicensingInfoInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this get domain licensing info internal server error response a status code equal to that given
func (o *GetDomainLicensingInfoInternalServerError) IsCode(code int) bool {
	return code == 500
}

func (o *GetDomainLicensingInfoInternalServerError) Error() string {
	return fmt.Sprintf("[GET /v1/licensing-info/domains/{id}][%d] getDomainLicensingInfoInternalServerError  %+v", 500, o.Payload)
}

func (o *GetDomainLicensingInfoInternalServerError) String() string {
	return fmt.Sprintf("[GET /v1/licensing-info/domains/{id}][%d] getDomainLicensingInfoInternalServerError  %+v", 500, o.Payload)
}

func (o *GetDomainLicensingInfoInternalServerError) GetPayload() *models.Error {
	return o.Payload
}

func (o *GetDomainLicensingInfoInternalServerError) readResponse(response runtime.ClientResponse, consumer runtime.Consumer, formats strfmt.Registry) error {
