...
func (o *GetLicenseKeysReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/license-keys] getLicenseKeys", response, response.Code())
	}
}
...
// Code gets the status code for the get license keys o k response
func (o *GetLicenseKeysOK) Code() int {
	return 200
}
...
// Code gets the status code for the get license keys internal server error response
func (o *GetLicenseKeysInternalServerError) Code() int {
	return 500
}
