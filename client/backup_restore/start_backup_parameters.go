...
// WithBackupsSpec adds the backupsSpec to the start backup params
func (o *StartBackupParams) WithBackupsSpec(backupsSpec *models.BackupSpec) *StartBackupParams {
	o.SetBackupsSpec(backupsSpec)
	return o
}

// SetBackupsSpec adds the backupsSpec to the start backup params
func (o *StartBackupParams) SetBackupsSpec(backupsSpec *models.BackupSpec) {
