...
GetSSODomainsParams contains all the parameters to send to the API endpoint
	...
	for the get s s o domains operation.
...
// WithDefaults hydrates default values in the get s s o domains params (not the query body).
//
...
// SetDefaults hydrates default values in the get s s o domains params (not the query body).
//
// All values with no default are reset to their zero value.
...
// WithTimeout adds the timeout to the get s s o domains params
func (o *GetSSODomainsParams) WithTimeout(timeout time.Duration) *GetSSODomainsParams {
	o.SetTimeout(timeout)
	return o
}

// SetTimeout adds the timeout to the get s s o domains params
func (o *GetSSODomainsParams) SetTimeout(timeout time.Duration) {
	o.timeout = timeout
}

// WithContext adds the context to the get s s o domains params
func (o *GetSSODomainsParams) WithContext(ctx context.Context) *GetSSODomainsParams {
	o.SetContext(ctx)
	return o
}

// SetContext adds the context to the get s s o domains params
func (o *GetSSODomainsParams) SetContext(ctx context.Context) {
	o.Context = ctx
}

// WithHTTPClient adds the HTTPClient to the get s s o domains params
func (o *GetSSODomainsParams) WithHTTPClient(client *http.Client) *GetSSODomainsParams {
	o.SetHTTPClient(client)
	return o
}

// SetHTTPClient adds the HTTPClient to the get s s o domains params
