...
func (o *GetVRSLCMReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/vrslcm] getVrslcm", response, response.Code())
	}
}
...
// Code gets the status code for the get Vrslcm o k response
func (o *GetVRSLCMOK) Code() int {
	return 200
}
...
// Code gets the status code for the get Vrslcm not found response
func (o *GetVRSLCMNotFound) Code() int {
	return 404
}
