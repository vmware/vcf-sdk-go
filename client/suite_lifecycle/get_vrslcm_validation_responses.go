...
func (o *GetVRSLCMValidationReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 404:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/vrslcms/validations/{id}] getVrslcmValidation", response, response.Code())
	}
}
...
// Code gets the status code for the get Vrslcm validation o k response
func (o *GetVRSLCMValidationOK) Code() int {
	return 200
}
...
// Code gets the status code for the get Vrslcm validation bad request response
func (o *GetVRSLCMValidationBadRequest) Code() int {
	return 400
}
...
// Code gets the status code for the get Vrslcm validation not found response
func (o *GetVRSLCMValidationNotFound) Code() int {
	return 404
}
