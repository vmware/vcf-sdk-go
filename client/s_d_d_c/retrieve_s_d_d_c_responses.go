...
// IsSuccess returns true when this retrieve s d d c o k response has a 2xx status code
func (o *RetrieveSDDCOK) IsSuccess() bool {
	return true
}

// IsRedirect returns true when this retrieve s d d c o k response has a 3xx status code
func (o *RetrieveSDDCOK) IsRedirect() bool {
	return false
}

// IsClientError returns true when this retrieve s d d c o k response has a 4xx status code
func (o *RetrieveSDDCOK) IsClientError() bool {
	return false
}

// IsServerError returns true when this retrieve s d d c o k response has a 5xx status code
func (o *RetrieveSDDCOK) IsServerError() bool {
	return false
}

// IsCode returns true when this retrieve s d d c o k response a status code equal to that given
...
// IsSuccess returns true when this retrieve s d d c bad request response has a 2xx status code
func (o *RetrieveSDDCBadRequest) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this retrieve s d d c bad request response has a 3xx status code
func (o *RetrieveSDDCBadRequest) IsRedirect() bool {
	return false
}

// IsClientError returns true when this retrieve s d d c bad request response has a 4xx status code
func (o *RetrieveSDDCBadRequest) IsClientError() bool {
	return true
}

// IsServerError returns true when this retrieve s d d c bad request response has a 5xx status code
func (o *RetrieveSDDCBadRequest) IsServerError() bool {
	return false
}

// IsCode returns true when this retrieve s d d c bad request response a status code equal to that given
...
// IsSuccess returns true when this retrieve s d d c not found response has a 2xx status code
func (o *RetrieveSDDCNotFound) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this retrieve s d d c not found response has a 3xx status code
func (o *RetrieveSDDCNotFound) IsRedirect() bool {
	return false
}

// IsClientError returns true when this retrieve s d d c not found response has a 4xx status code
func (o *RetrieveSDDCNotFound) IsClientError() bool {
	return true
}

// IsServerError returns true when this retrieve s d d c not found response has a 5xx status code
func (o *RetrieveSDDCNotFound) IsServerError() bool {
	return false
}

// IsCode returns true when this retrieve s d d c not found response a status code equal to that given
...
// IsSuccess returns true when this retrieve s d d c internal server error response has a 2xx status code
func (o *RetrieveSDDCInternalServerError) IsSuccess() bool {
	return false
}

// IsRedirect returns true when this retrieve s d d c internal server error response has a 3xx status code
func (o *RetrieveSDDCInternalServerError) IsRedirect() bool {
	return false
}

// IsClientError returns true when this retrieve s d d c internal server error response has a 4xx status code
func (o *RetrieveSDDCInternalServerError) IsClientError() bool {
	return false
}

// IsServerError returns true when this retrieve s d d c internal server error response has a 5xx status code
func (o *RetrieveSDDCInternalServerError) IsServerError() bool {
	return true
}

// IsCode returns true when this retrieve s d d c internal server error response a status code equal to that given
