...
func (o *GetBundlesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/bundles] getBundles", response, response.Code())
	}
}
...
// Code gets the status code for the get bundles internal server error response
func (o *GetBundlesInternalServerError) Code() int {
	return 500
}
