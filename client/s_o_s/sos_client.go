...
// New creates a new s o s API client.
func New(transport runtime.ClientTransport, formats strfmt.Registry) ClientService {
	return &Client{transport: transport, formats: formats}
}

/*
Client for s o s API
*/
type Client struct {
...
func (a *Client) HealthSummary(params *HealthSummaryParams, opts ...ClientOption) (*HealthSummaryOK, *HealthSummaryAccepted, error) {
	...
	// safeguard: normally, absent a default response, unknown success responses return an error above: so this is a codegen issue
	msg := fmt.Sprintf("unexpected success response for s_o_s: API contract not enforced by server. Client expected to get an error, but got: %T", result)
	panic(msg)
}
