...
func (o *GetVropsesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 200:
		...
		return result, nil
	default:
		return nil, runtime.NewAPIError("[GET /v1/vropses] getVropses", response, response.Code())
	}
}
...
// Code gets the status code for the get vropses o k response
func (o *GetVropsesOK) Code() int {
	return 200
}
