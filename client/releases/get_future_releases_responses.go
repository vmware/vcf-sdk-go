...
func (o *GetFutureReleasesReader) ReadResponse(response runtime.ClientResponse, consumer runtime.Consumer) (interface{}, error) {
	...
	case 500:
		...
		return nil, result
	default:
		return nil, runtime.NewAPIError("[GET /v1/releases/domains/{domainId}/future-releases] getFutureReleases", response, response.Code())
	}
}
...
// Code gets the status code for the get future releases o k response
func (o *GetFutureReleasesOK) Code() int {
	return 200
}
...
// Code gets the status code for the get future releases not found response
func (o *GetFutureReleasesNotFound) Code() int {
	return 404
}
...
// Code gets the status code for the get future releases internal server error response
func (o *GetFutureReleasesInternalServerError) Code() int {
	return 500
}
